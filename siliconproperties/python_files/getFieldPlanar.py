...
def get_field_planar(x, V_bias, n_eff, D):
    """ Calculates the field E_x[V/um] in a planar sensor as a
...
if __name__ == '__main__':
    ...
    plt.legend(loc=0)
    plt.grid()
    plt.savefig('PlanarEfield.pdf', layout='tight')
    plt.show()
