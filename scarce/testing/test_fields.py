...
#                              is_planar=True)
        ...
        self.assertTrue(tools.check_with_fixture(get_weighting_potential,
                             x=np.linspace(-200, 200, 200), 
                             y=np.linspace(0, 250, 200), 
                             D=[100, 150, 200, 250], 
                             S=[5, 50, 100, 150, 250], 
...
#                              is_planar=True)
        ...
        self.assertTrue(tools.check_with_fixture(get_weighting_field,
                             x=np.linspace(-200, 200, 200), 
                             y=np.linspace(0, 250, 200), 
                             D=[100, 150, 200, 250], 
                             S=[5, 50, 100, 150, 250], 
    ...
    def test_w_pot_field_analytic(self):
        ...
        e_w_x, e_w_y = get_weighting_field(xx, yy, D=width, S=thickness, is_planar=True)
